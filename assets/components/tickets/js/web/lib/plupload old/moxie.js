				...
				self.bind('RuntimeInit', function(e, runtime) {
					...
					self.bind('Refresh', function() {
						...
						if (browseButton) {
							...
							zIndex = parseInt(Dom.getStyle(browseButton, 'z-index'), 999999) || 0;
	...
	function FileInput() {
		...
		Basic.extend(this, {
			init: function(options) {
				...
				shimContainer.innerHTML = '<input id="' + I.uid +'" type="file" style="font-size:999px;z-index:999;opacity:0;"' +
					(_options.multiple && I.can('select_multiple') ? 'multiple' : '') + 
					(_options.directory && I.can('select_folder') ? 'webkitdirectory directory' : '') + // Chrome 11+
					(mimes ? ' accept="' + mimes.join(',') + '"' : '') + ' capture />';
				...
				if (I.can('summon_file_dialog')) {
					...
					comp.bind('Refresh', function() {
						...
						this.getRuntime().getShimContainer().style.zIndex = zIndex - 999;
					});
				}
				...
				switch (name) {
					...
					case 'multiple':
						if (value && I.can('select_multiple')) {
							input.setAttribute('multiple capture', '');
						} else {
		...
		Basic.extend(this, {
			init: function(options) {
				...
				(function() {
					...
					browseButton = Dom.get(options.browse_button);
					_browseBtnZIndex = Dom.getStyle(browseButton, 'z-index') || '999';
